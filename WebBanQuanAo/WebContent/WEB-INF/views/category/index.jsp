...
<link href="<c:url value='/resources/styles/categories_styles.css' />" rel="stylesheet" />
<link href="<c:url value='/resources/styles/categories_responsive.css' />" rel="stylesheet" />
</head>
<body>
