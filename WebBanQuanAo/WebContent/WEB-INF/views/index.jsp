...
<body>
    ...
    <div class="super_container">
                                ...
                                <div class="product-item 2">
                                    <div class="product discount product_filter">
                                        ...
                                        <div class="product_info">
                                            ...
                                            <div class="product_price">${f.price-(f.price*((f.discount)/100))}k<span>${f.price}k</span></div>
                                        </div>
                                    </div>
        ...
        <div class="deal_ofthe_week">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="deal_ofthe_week_img"><img src="<c:url value="/resources/images/deal_ofthe_week.png" />" alt=""></div>
                    </div>
	...
	<script>
		...
		var countDownDate = new Date("June 29, 2022 00:00:00").getTime();
